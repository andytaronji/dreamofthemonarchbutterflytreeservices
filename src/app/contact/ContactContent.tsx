            ...
            <div>
              ...
              <div className="mt-10">
                ...
                <div className="flex space-x-4">
                  <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="bg-monarch-yellow/20 p-3 rounded-full text-monarch-orange hover:bg-monarch-yellow/30 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" />
                    </svg>
                  </a>
                  <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="bg-monarch-yellow/20 p-3 rounded-full text-monarch-orange hover:bg-monarch-yellow/30 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a href="https://google.com" target="_blank" rel="noopener noreferrer" className="bg-monarch-yellow/20 p-3 rounded-full text-monarch-orange hover:bg-monarch-yellow/30 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
